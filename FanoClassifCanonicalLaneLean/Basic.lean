/-!
# fano-classif Lean migration boundary
...
`fano_classif/SourcePackage.lean`.
...
def sourceRepository : String := "fano-classif"
def sourceUrl : String := "https://github.com/HautevilleHouse/fano-classif"
def sourceDescription : String := "Canonical-lane closure package for the Classification of Fano Varieties (Birkar et al.): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["fano-classif", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
