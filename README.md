# Classification of Fano Varieties (Birkar et al.) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Classification of Fano Varieties (Birkar et al.).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/fano-classif-mathlib.git
cd fano-classif-mathlib
lake exe
lake build
```
